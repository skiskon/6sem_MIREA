...
//
//        list.add(new Data(1), 5); vivod(list);
//        list.add(new Data(2), 5);vivod(list);
//        list.add(new Data(3), 5);vivod(list);
//        list.add(new Data(4), 5);vivod(list);
//        list.add(new Data(5), 5);vivod(list);
//        list.add(new Data(6), 5);vivod(list);
//        list.add(new Data(7), 5);vivod(list);
//        list.dell(2);
